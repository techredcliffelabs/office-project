resource "google_logging_project_sink" "my-qa-sink" {
  ...
  destination = "logging.googleapis.com/projects/tcl-prod-audit-logs-0/locations/us-central1/buckets/audit-logs_non-prod-qa"
  ...
  depends_on = [
    google_project_iam_binding.dev-log-writer
  ]
}
